...
INSERT INTO visits (animals_id, vets_id, date_of_visit) SELECT * FROM (SELECT animal_id FROM animals) animal_ids, (SELECT vet_id FROM vets) vets_ids, generate_series('1980-01-01'::timestamp, '2021-01-01', '4 hours') visit_timestamp;
...
INSERT INTO visits (animals_id, vets_id, date_of_visit) SELECT * FROM (SELECT animal_id FROM animals) animal_ids, (SELECT vet_id FROM vets) vets_ids, generate_series('1980-01-01'::timestamp, '2021-01-01', '4 hours') visit_timestamp;
insert into owners (fullname, email) select 'Owner ' || generate_series(3,2500000), 'owner_' || generate_series(3,2500000) || '@mail.com';